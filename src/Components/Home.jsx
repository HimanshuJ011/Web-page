...
const headOpt = {
    pos:'absolute', left :"50%", top:"50%", transform:"translate(-50$, -50%)",size:"4xl",
    ...
    return(
        <Box>
            ...
            <Container p="16" maxW={'container.xl'} minH={'100vh'}>
                ...
                <Text letterSpacing={'wideset'} lineHeight={'190%'} p={['4','16']} textAlign={'center'}>
